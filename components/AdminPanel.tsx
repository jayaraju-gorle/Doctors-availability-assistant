...
const AdminPanel: React.FC<AdminPanelProps> = ({ recordings, chatSessions, onBack, error }) => {
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-red-700">
                <p>You do not have permission to view this data. Please check your Firebase Security Rules.</p>
              </div>
            </div>
          </div>
        </div>
